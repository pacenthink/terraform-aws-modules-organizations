# fajardo-trucking-shared-gcp-infra
...
- Git version `>= 2.33.0`.
- An existing AWS IAM user or role with access to create/update/delete resources defined in [main.tf](https://github.com/nurdsoft/fajardo-trucking-shared-gcp-infra/blob/main.tf).
...
```sh
# Using Git
$ git clone git@github.com:nurdsoft/fajardo-trucking-shared-gcp-infra.git

# Using HTTPS
$ git clone https://github.com/nurdsoft/fajardo-trucking-shared-gcp-infra.git
```
